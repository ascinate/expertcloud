...
import NewsDetails from "./NewsAllApi";


function News(){
    document.title ="Expert Cloud -  News"
    const [ workData , setworkData] =useState(NewsDetails);
          ...
          <div className="dasb-div bk-div float-start w-100">
             ...
             <div className="body-expart-div projects-pages support-page">
                ...
                <div className="news-section mb-5">
                     <div className="row row-cols-1 row-cols-sm-2 row-cols-lg-2 row-cols-xl-3">
...

                        {
                            workData.map((curElem) => {
                                const{ id, para, titel, tags,date, time,img} = curElem;
                                return(
                                    <>
                                    <div className="col">
                                        ...
                                        <h6 className="date-t"> at {date} : {time} </h6>
                                        </div>
                                    </div>
                                    </>
                                );
                     ...
                     <a id="#" className="loading-btn btn text-center mx-auto d-table mt-4">
                     <FaRedo/> Load More News </a>
                </div>
