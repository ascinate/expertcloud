...
function PrivacyPolicy(){
    Aos.init({
        ...
        document.title ="Expert Cloud -  Privacy Policy"
    return(
        <>
        <Header/>
                ...
                <div className="container">
                     ...
                     <div className="inside-page">
                        <div className="comon-privacy">
                           ...
                           <p> Ipsum consequat nisl vel pretium. Risus pretium quam vulputate dignissim suspendisse in est ante in. Bibendum neque egestas congue quisque egestas. Et pharetra pharetra massa massa ultricies mi. Nunc congue nisi vitae suscipit tellus mauris a. Nulla aliquet porttitor lacus luctus accumsan tortor. Vulputate eu scelerisque felis imperdiet proin. Magna sit amet purus gravida quis. Velit laoreet id donec ultrices tincidunt arcu. Sit amet consectetur adipiscing elit duis tristique sollicitudin nibh sit. Amet nisl purus in mollis nunc. Vitae congue mauris rhoncus aenean vel elit scelerisque. Erat pellentesque adipiscing commodo elit at imperdiet dui accumsan sit. Erat velit scelerisque in dictum non. Molestie at elementum eu facilisis sed odio. Augue mauris augue neque gravida. Pretium fusce id velit ut tortor pretium viverra suspendisse potenti. Penatibus et magnis dis parturient. Suscipit tellus mauris a diam maecenas sed enim ut. Mi ipsum faucibus vitae aliquet nec ullamcorper sit amet risus.
